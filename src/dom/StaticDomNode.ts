...
export default class StaticDomNode extends TreeNode {
  declare public parent: StaticDomNode | undefined;
  public children: StaticDomNode[] = [];
  ...
  public clone() {
    const dom = new StaticDomNode(this.tag);
  ...
  public build(): string {
    ...
    let className: string | undefined = this._classes === ""
      ? undefined
      : this._classes;
